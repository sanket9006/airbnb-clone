    ...
    return (
        <header className='bg-white grid grid-cols-3 shadow-md p-3 sticky top-0 z-50'>
            ...
            <div className='flex border-2 rounded-full my-auto justify-between h-10 items-center md:shadow-sm'>
                ...
                <SearchIcon className="hidden md:inline-flex bg-transparent rounded-full cursor-pointer bg-red-400 color-red-300 h-6 text-white p-1 mr-3" />
            </div>

            {/* Right */}
            <div className='flex items-center justify-end space-x-3'>
                <p className='hidden md:inline  cursor-pointer hover:bg-gray-100 px-3 py-2 rounded-full font-semibold'>Airbnb your home</p>
